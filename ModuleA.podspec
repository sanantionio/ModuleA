...
Pod::Spec.new do |s|
  ...
  s.author             = { "sanantionio" => "295694292@qq.com" }
  # Or just: s.author    = "sanantionio"
  # s.authors            = { "sanantionio" => "295694292@qq.com" }
  # s.social_media_url   = "http://twitter.com/sanantionio"
